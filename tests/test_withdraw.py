...
class TestBankWithdrawal(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
      print('Test Cases starting for Bank Module withdrawal fund')

    @classmethod
    def tearDownClass(cls):
      print('Test Case finished for Bank Module withdrawal fund')
    ...
    def test_withdraw_correct_remaining_balance(self):
      ...
      user_1_bank.withdraw(3000.00)
      self.assertEqual(user_1_bank.balance, 2000)
      user_1_bank.withdraw(959.63)
      self.assertEqual(user_1_bank.balance, 1040.37)
      user_1_bank.withdraw(121.6374)
      self.assertEqual(user_1_bank.balance, 918.73)
